...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', default='preprocessed/train_aug_5.csv')
    parser.add_argument('--dev_path', default='preprocessed/combined_dev_5.csv')
    parser.add_argument('--test_path', default='preprocessed/combined_dev_5.csv')
    ...
    # 학습이 완료된 모델을 저장합니다.
    torch.save(model, 'model/model_m_4.pt')
