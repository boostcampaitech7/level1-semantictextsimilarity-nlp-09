...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', default='preprocessed/train_preprop_v2_oversampled.csv')
    parser.add_argument('--dev_path', default='preprocessed/dev_preprop_v2.csv')
    parser.add_argument('--test_path', default='preprocessed/dev_preprop_v2.csv')
    parser.add_argument('--predict_path', default='preprocessed/test_preprop_v2.csv')
    ...
    # 학습이 완료된 모델을 저장합니다.
    torch.save(model, 'model/model_m_9.pt')
