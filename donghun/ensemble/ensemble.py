...
if __name__ == "__main__":
    ...
    file_paths = ["./ensamble/data/0.9330412_snunlp-KR-ELECTRA-discriminator_output.csv",
                  "./ensamble/data/DH_KrELRCTRA_9302.csv",
                  "./ensamble/data/DH_KrELRCTRA_9315.csv",
                  "./ensamble/data/output_hj_large_9334.csv",
                  "./ensamble/data/output_1.csv"
                  "./ensamble/data/output_6.csv"
                  "./ensamble/data/output_8.csv"
                  ]
